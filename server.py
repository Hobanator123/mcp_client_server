...
@mcp.tool()
def pause_spotify_playback(headers: dict, device_id: str):
...
@mcp.tool()
def resume_spotify_playback(headers: dict, device_id: str):
...
@mcp.tool()
def transfer_spotify_playback(headers: dict, device_id: str):
    """
...
# response = pause_spotify_playback(headers, laptop_device_id)

# print("waiting 3 seconds...")
# time.sleep(3)

# print("resuming spotify")
# response = resume_spotify_playback(headers, laptop_device_id)

# print("waiting 3 seconds...")
# time.sleep(3)

# print("transferring spotify")
# response = transfer_spotify_playback(headers, phone_device_id)